          ...
          >
            {favorites.length === 0 ? (
              ...
              favorites.map((fav) => {
                ...
                return (
                  <View key={fav.place_id} style={[modalStyles.listItem, styles.listItemColumn]}>
                      ...
                      <View style={styles.rowCenter}>
                        <View style={modalStyles.flex1}>
                          ...
                          {!isExpanded && fav.userNotes ? (
                            <Text
                              style={[modalStyles.listItemSub, modalStyles.fontItalic]}
                              numberOfLines={1}
                            >
                              {fav.userNotes}
                            </Text>
                    ...
                    {isExpanded && (
                      <View style={styles.favDetailSection}>
                        ...
                        <View style={styles.favActionRow}>
                          ...
                          <TouchableOpacity
                            onPress={() => {
                              showAlert('Remove Favorite', `Remove "${fav.name}" from favorites?`, [
