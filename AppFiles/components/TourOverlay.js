 ...
 * @returns {JSX.Element}
 */
function TourOverlay({ visible, tourStep, tourSpotLayout, onAdvance, onRetreat, onClose }) {
    ...
    >
      <View style={styles.tourOverlay} accessibilityViewIsModal>
        ...
        {(() => {
          ...
          const BOTTOM_SAFE = 48; // keep clear of nav bar / gesture area
          ...
          if (tourSpotLayout && tooltipBelow) {
            ...
            // Anchor tooltip bottom to the top of the spotlight
            tooltipPosition = {
              bottom: screenH - tourSpotLayout.y + TOUR_SPOT_PAD,
            };
          }
          return (
