            ...
            <>
              ...
              >
                ...
                <TextInput
                  ...
                  placeholder="Area center to search — address or spot"
                  placeholderTextColor={THEME.textHint}
                  value={gLocQuery}
                ...
                {gLocSuggestions.length > 0 && (
                  <View style={styles.groupLocSuggestions}>
                    {gLocSuggestions.map((s) => (
                      ...
                      >
                        {s.isCustomSpot && <Ionicons name="bookmark" size={14} color={THEME.pop} />}
                ...
                <TextInput
                  style={[
                    styles.groupInput,
                    styles.marginTop8,
                    gLocFromSpot && styles.groupInputLocked,
                  ]}
                ...
                {gLocCoords &&
                  ...
                  (() => {
                    const matchedSpot = customPlaces.find(
                      (cp) =>
                        cp.vicinity &&
                        cp.vicinity.toLowerCase() === (gLocQuery || gLocCoords.label).toLowerCase(),
                    );
                    return (
                        ...
                        {matchedSpot ? (
                          <View style={styles.groupSaveSpotBtn}>
                            ...
                            <Text style={styles.groupSaveSpotText}>
                              Already in Spots as &ldquo;{matchedSpot.name}&rdquo;
                            </Text>
                          </View>
                        ) : (
                          <TouchableOpacity
                ...
                <TouchableOpacity
                  style={[
                    ...
                    !canHost && styles.groupBtnDisabled,
                  ]}
                  onPress={() => (canHost ? groupCreate(gLocCoords) : showPaywall('group'))}
...
const styles = StyleSheet.create({
  ...
  supportBtnText: { color: THEME.white, fontSize: 17, fontWeight: '700' },
